...
const localeCases: LocaleCase[] = [
  {
    ...
    heroLine1: "I build systems",
    heroLine2: "that scale.",
    headerRole: "Product Engineer · Web, PWA & Android",
    formName: "Your name",
  ...
  },
  {
    ...
    heroLine1: "سیستم‌هایی می‌سازم",
    heroLine2: "که برای رشد آماده‌اند.",
    headerRole: "مهندس محصول · وب، PWA و Android",
    formName: "نام شما",
  ...
  },
  {
    ...
    manifestScope: "/",
    manifestName: "Signal Atelier Portfolio",
    heroLine1: "Ich entwickle Systeme,",
    heroLine2: "die mitwachsen.",
    headerRole: "Produktentwickler · Web, PWA & Android",
    formName: "Ihr Name",
