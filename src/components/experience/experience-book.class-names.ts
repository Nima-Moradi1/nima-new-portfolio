export const experienceBookClassNames = {
  ...
  stage:
    "experience-book__stage sticky top-0 isolate h-svh min-h-[42rem] overflow-clip [--book-copy-width:min(50vw,47rem)] [--book-scene-left:clamp(21rem,29vw,28rem)] focus-visible:outline-2 focus-visible:-outline-offset-8 focus-visible:outline-primary max-[72rem]:[--book-copy-width:min(53vw,40rem)] max-[72rem]:[--book-scene-left:clamp(18rem,31vw,22rem)] max-[54rem]:min-h-[45rem] max-[54rem]:[--book-copy-width:min(86vw,42rem)] max-[54rem]:[--book-mobile-scene-height:clamp(18.5rem,44svh,25rem)] max-[54rem]:[--book-mobile-scene-top:clamp(15.75rem,33vw,17rem)] max-[54rem]:[--book-scene-left:0rem] max-[38rem]:[--book-mobile-scene-height:clamp(18rem,42svh,22rem)] max-[38rem]:[--book-mobile-scene-top:16rem] min-[72.01rem]:[--book-copy-width:clamp(39rem,44vw,50rem)] min-[72.01rem]:[--book-scene-left:var(--experience-book-heading-width)] min-[72.01rem]:[--experience-book-content-top:calc(var(--header-height)+0.55rem)] min-[72.01rem]:[--experience-book-heading-width:clamp(18rem,31vw,28rem)]",
  heading:
    "experience-book__heading page-shell pointer-events-none absolute inset-x-0 top-[calc(var(--header-height)+0.55rem)] z-4 mx-auto w-full max-w-[var(--content-width)] px-[var(--gutter)] min-[72.01rem]:inset-e-auto min-[72.01rem]:start-0 min-[72.01rem]:m-0 min-[72.01rem]:h-fit min-[72.01rem]:w-[var(--experience-book-heading-width)] min-[72.01rem]:max-w-none min-[72.01rem]:py-0 min-[72.01rem]:ps-[var(--gutter)] min-[72.01rem]:pe-[clamp(1.25rem,3vw,3rem)] min-[72.01rem]:top-[var(--experience-book-content-top)]",
  headingEyebrow:
