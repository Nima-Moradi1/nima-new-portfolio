export const heroSectionClassNames = {
  ...
  title:
    "max-w-[12ch] text-[clamp(3.8rem,6.4vw,7.4rem)] leading-[0.88] font-[560] tracking-[-0.075em] text-balance max-[72rem]:text-[clamp(3.8rem,7.2vw,5.9rem)] max-[54rem]:max-w-[11ch] max-[54rem]:text-[clamp(3.45rem,11.5vw,5.7rem)] max-[38rem]:text-[clamp(3.15rem,15vw,4.8rem)] [html[lang=fa]_&]:max-w-[min(100%,20ch)] [html[lang=fa]_&]:text-[clamp(2.28rem,3.8vw,4.3rem)] [html[lang=fa]_&]:leading-[1.24] [html[lang=fa]_&]:tracking-normal [html[lang=fa]_&]:text-start [html[lang=fa]_&]:break-words max-[72rem]:[html[lang=fa]_&]:text-[clamp(2.28rem,4.25vw,3.62rem)] max-[54rem]:[html[lang=fa]_&]:text-[clamp(2.12rem,7vw,3.36rem)] max-[54rem]:[html[lang=fa]_&]:leading-[1.22] max-[38rem]:[html[lang=fa]_&]:text-[clamp(1.95rem,9.2vw,2.86rem)]",
  titleOutline:
