export const sectionHeadingClassNames = {
  ...
  meta: "section-heading__meta flex items-start gap-[1.2rem] pt-[0.15rem] font-mono text-[0.66rem] tracking-[0.1em] text-muted-foreground uppercase [html[lang=fa]_&]:font-[var(--font-vazirmatn),Tahoma,Arial,sans-serif] [html[lang=fa]_&]:text-[clamp(0.64rem,0.72vw,0.76rem)] [html[lang=fa]_&]:leading-[1.55] [html[lang=fa]_&]:tracking-normal [html[lang=fa]_&]:normal-case",
  index: "text-primary",
