export const siteHeaderClassNames = {
  ...
  mark: "site-header__mark grid size-[2.6rem] place-items-center rounded-full border border-line-strong font-mono text-[0.72rem] tracking-[-0.04em] text-primary [direction:ltr] [unicode-bidi:isolate]",
